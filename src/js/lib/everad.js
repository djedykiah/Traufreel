// Everad 4.0, с фиксом через cdn_path, для проверки на сервере
...
// Розділяєм час таймера порозрядно: додаєм на <body> class="timer-different". Приклад, https://prnt.sc/jeoy27
// Задаємо свій час для таймера через <body data-timer="N">, де N - кількість хвилин.
        ...
        function initiate() {
            ...
            function initializeTimer() {
                ...
                if (!localStorage.getItem("ever-timer")) {
                	var	body = +document.body.getAttribute('data-timer'),
                		time = (body && body > 0) ? body : 27;
